...
const battleUiTextStyle = { color: 'black', fontSize: '30px' };
...
export class BattleMenu {
    ...
    #createMainBattleMenu() {
        this.#battleTextGameObjectLine1 = this.#scene.add.text(20, 460, `What should`, battleUiTextStyle);
